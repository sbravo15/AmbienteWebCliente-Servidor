...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-04-2022 a las 18:02:12
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `ActualizarZapato` (IN `pcodigo` BIGINT, IN `pprecio` INT, IN `pobligatorio` INT, IN `popcional` INT)  BEGIN

UPDATE zapato
SET Precio = pprecio,
	PorcObligatorio = pobligatorio,
    PorcOpcional = popcional
